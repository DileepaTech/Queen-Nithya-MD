 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    function miaa() {
                        const corea = ["disablepm", "stateObject", "commands", "900dZcbVK", "length", "Auto Read Status: ✅", "25524zIwSmd", "false",    await Void.sendPresenceUpdate('recording', citel.chat);
