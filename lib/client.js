 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                       Void.sendMessage(i + "@s.whatsapp.net", { text: `💞ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ᴛʜᴇ NITHYA ᴠ1 ᴍᴅ💞
                        _____________________________________
                        💞Owner = Dileepa💞
                        _____________________________________
                        💞ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏNITHYA ᴍᴅ💞
                        _____________________________________
