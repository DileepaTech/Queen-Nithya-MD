		...
		if (citel.sender === devss){ citel.react('🤴') };   
		 ...
		 const hansamala = '94705674697@s.whatsapp.net'
		    ...
		    if (citel.sender === thushan){ citel.react('🧛🏼‍♂️') };
                const sandesh = '94774071805@s.whatsapp.net'
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `💞NITHYA V1 CONNECTED💞
                        _____________________________________
                        Develped By Yasas Dileepa And His Team
                        _____________________________________
                        💞ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴛᴏ ɪɴꜱᴛᴀʟʟᴇᴅ ʏᴏᴜʀ ᴅᴇᴠɪᴄᴇ💞
                        ` })
                    }
		    }
...
app.listen(port, () => console.log(`NITHYA Server listening on port http://localhost:${port}!`));
